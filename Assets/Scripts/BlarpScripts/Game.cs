...
public class Game : MonoBehaviour
{
  ...
  public virtual void DoWallHit(float magnitude) { }
  ...
  public void SetUpMenu()
  {
    ...
    scoreText.transform.position = new Vector3(-screen.width * .5f + 1, 7, screen.height * .5f - .5f);
    socialButtons.position = new Vector3(screen.width * .5f - 1, 1, -screen.height * .5f + 1);
    title.position = new Vector3(-screen.width * .5f + 1, 1, screen.height * .5f - .5f);
  }
